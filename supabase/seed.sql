...
insert into public.posts (slug, title, description, content, published_at, tags, featured) values

(
  'balancing-hobbies-and-coding',
...
— Paulina$$,
  ...
  array['hobbies', 'motivation', 'wellness'],
  true
),

(
  '5-books-that-shaped-my-coding-journey',
...
— Paulina$$,
  ...
  array['books', 'reading', 'inspiration'],
  true
),
...
— Paulina$$,
  ...
  array['career', 'mindset', 'beginners'],
  false
),
...
—Paulina$$,
  ...
  array['css', 'responsive', 'frontend'],
  false
),

(
  'dev-tools-for-productivity',
...
**Paulina**$$,
  ...
  array['tools', 'productivity', 'vscode'],
  false
),
...
Most importantly, keep it fun! I'm excited to continue exploring more complex concepts—like arrays, objects, and eventually frameworks like React. Thanks for reading, and happy coding!$$,
  ...
  array['javascript', 'basics', 'beginners'],
  false
),
...
Alright, that's all for now. Thanks for reading, and I'll be back soon with more updates!$$,
  ...
  array['html', 'css', 'basics', 'beginners'],
  false
),
...
**Paulina**$$,
  ...
  array['career', 'frontend', 'beginners'],
  false
);
